export function SceneBackdrop() {
  return (
    <div className="scene-backdrop" aria-hidden="true">
      ...
      <span className="scene-backdrop__fog scene-backdrop__fog--far" />
      <span className="scene-backdrop__fog scene-backdrop__fog--mid" />
      <span className="scene-backdrop__fog scene-backdrop__fog--near" />
