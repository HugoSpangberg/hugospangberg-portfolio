...
export const content = {
  sv: {
    seo: {
      ...
      description:
        'Portfolio för Hugo Spångberg, webbutvecklare och systemutvecklare med fokus på .NET, automation, kvalitet och nytta i praktiken.',
    },
    nav: [
    ...
    hero: {
      ...
      subtitle:
        'Jag bygger moderna webb- och systemlösningar med fokus på .NET, automation, kvalitet och nytta i verkligheten. Med erfarenhet från IoT, processautomation, test och design gillar jag att skapa lösningar som är stabila, begripliga och användbara i praktiken.',
      tagline:
    ...
    about: {
      ...
      paragraphs: [
        ...
        'Den här portfolion är inspirerad av nordisk skog, teknik och subtil sci-fi. Det är ungefär där mina erfarenheter och personliga intressen möts.',
      ],
    ...
    contact: {
      ...
      paragraphs: [
        'Jag är öppen för roller inom webbutveckling, systemutveckling och backendutveckling. Jag trivs särskilt bra där teknik, kvalitet och verkliga behov möts. Hör gärna av dig om du söker en utvecklare som är nyfiken, ansvarstagande och van vid att arbeta nära både teknik och människor.',
      ],
      cta: 'Kontakta mig',
  ...
  en: {
    seo: {
      ...
      description:
        'Portfolio for Hugo Spångberg, a web and software developer focused on .NET, automation, quality and real-world usefulness.',
    },
    nav: [
    ...
    hero: {
      ...
      subtitle:
        'I build modern web and software solutions with a focus on .NET, automation, quality and real-world usefulness. With experience from IoT, process automation, testing and design, I like creating solutions that are stable, understandable and useful in practice.',
      tagline:
        'Code, systems and problem-solving with roots in the forest and eyes on what comes next.',
    ...
    about: {
      ...
      paragraphs: [
        ...
        'This portfolio is inspired by Nordic forest, technology and subtle sci-fi. That is where my work experience and personal interests meet.',
      ],
    ...
    contact: {
      ...
      paragraphs: [
        'I am open to roles within web development, software development and backend development. I especially enjoy work where technology, quality and real business needs meet. Feel free to reach out if you are looking for a developer who is curious, responsible and used to working close to both technology and people.',
      ],
      cta: 'Contact me',
