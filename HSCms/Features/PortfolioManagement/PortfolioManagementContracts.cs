...
public static partial class PortfolioManagementValidation
{
    ...
    private static void ValidateUrl(Dictionary<string, string[]> errors, string field, string? value)
    {
    ...
    private static void Require(Dictionary<string, string[]> errors, string field, string? value, string message)
    {
        if (string.IsNullOrWhiteSpace(value))
        {
