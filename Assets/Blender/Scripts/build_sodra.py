...
cube("LM_Sodra_RoofOverhang_CurvedBlock", (0, -1.34, 1.62), (2.42, 0.34, 0.07), mat["metal_dark"], 0.006, root)
cube("LM_Sodra_RoofDeck", (0.72, -1.12, 1.78), (0.9, 0.32, 0.06), mat["concrete_white"], 0.006, root)
cube("LM_Sodra_UpperGlassPavilion", (0.72, -1.14, 2.02), (0.74, 0.28, 0.28), mat["glass_cool"], 0.01, root)
cube("LM_Sodra_PavilionRoof", (0.72, -1.14, 2.2), (0.84, 0.34, 0.045), mat["metal_dark"], 0.004, root)
