...
cube("LM_Visma_DarkRoofline", (0, -0.02, 1.95), (2.48, 0.34, 0.055), mat["metal_dark"], 0.006, root)
cube("LM_Visma_RoofParapetGlass", (0, -0.16, 2.05), (2.32, 0.035, 0.12), mat["glass_cool"], 0.003, root)
...
cube("LM_Visma_EntranceCanopy", (0, -0.36, 0.78), (0.62, 0.14, 0.045), mat["concrete_white"], 0.008, root)
cube("LM_Visma_SignBoard", (0, -0.442, 0.83), (0.36, 0.02, 0.09), mat["concrete_white"], 0.004, root)
cube("LM_Visma_SignMark", (-0.13, -0.457, 0.83), (0.052, 0.008, 0.052), mat["facade_orange"], 0.003, root)
